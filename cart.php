...
switch($_GET["action"]) {
	case "add":
		if(!empty($_POST["quantity"])) {
			$productByCode = $db_handle->runQuery("SELECT * FROM games WHERE code='" . $_GET["code"] . "'");
...
<div class="cent" style="float:right;">
	<a style="width: 100px;px;height:15px" href="http://localhost/payment.html" class="button1" onclick="payment.html">Pay Now</a>
</div>		
  <?php
} else {
?>
...
<div id="product-grid">
	...
	<?php
	$product_array = $db_handle->runQuery("SELECT * FROM games ORDER BY id ASC");
	if (!empty($product_array)) { 
		foreach($product_array as $key=>$value){
	?>
		<div class="product-item">
			<form method="post" action="cart.php?action=add&code=<?php echo $product_array[$key]["code"]; ?>">
			<div class="product-image"><img src="<?php echo $product_array[$key]["image"]; ?>"></div><br/>
...
<div class="cent">
	<a href="http://localhost/index.php" class="button1">Back</a>
</div>
</BODY>
</HTML>